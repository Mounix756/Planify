...
<body>
    <div class="outer-container">
        <div class="inner-container">
            ...
            <p>{!!$sms!!}</h2>
            <p>Debut de la réunion : {{$get_start_time}}</p>
            <p>Fin de la réunion : {{$get_end_time}}</p>
            @if (!$get_meet_url == NULL)
                <p>Veillez cliquer sur ce bouton pour rejoindre le meet.</p>
                <h2 style="color: #007bff">Rejoindre</h2>
            ...
            <p>Email: <a href="mailto:contact@cityalert.com">contact@planify.com</a></p>
