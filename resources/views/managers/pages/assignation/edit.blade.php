...
<div class="content">
    ...
    <h2 class="mb-4">Modifier l'assignation de la tache</h2>
    <div class="row">
      <div class="col-xl-9">
        <form class="row g-3 mb-6" method="POST" action="{{route('update_assign')}}" enctype="multipart/form-data">
          @csrf
             @if(session('success'))
          ...
          <div class="col-12 gy-6">
            <div class="row g-3 justify-content-center">
              ...
              <div class="col-auto"><button type="submit" class="btn btn-primary px-5 px-sm-15">Mettre à jour</button></div>
            </div>
          </div>
        </form>
      </div>
