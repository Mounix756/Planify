<div class="modal fade" id="editTaskBtn" tabindex="-1" aria-labelledby="projectsBoardViewModal" aria-hidden="true">
      ...
      <div class="modal-content overflow-hidden">
        <div class="modal-header position-relative p-0">
          ...
          <div class="row mt-8" style="margin: 20px">
            <form method="post" action="{{ route('update_task', ['id' => $task->id]) }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                ...
                                <input class="form-control" name="name" type="text" placeholder="Nom de la tache *" value="{{$task->name}}" required/>
                            </div>

                            <div class="col-12" style="display: none">
                                <label class="form-label fs-8 text-body-highlight ps-0 text-transform-none" for="inputAddress1">ID</label>
                                <input class="form-control" name="user_id" type="text" value="{{Auth::guard('manager')->user()->id}}" placeholder="Oject *" />
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <input type="datetime-local" class="form-control" name="start_time" value="{{$task->start_time}}" required >
                            </div>

                            <div class="col-12">
                                <label class="form-label fs-8 text-body-highlight ps-0 text-transform-none" for="inputAddress1">Date de debut</label>
                                <input type="datetime-local" class="form-control" name="end_time" value="{{$task->end_time}}" required >
                            </div>


                            <div class="col-12">
                                <label class="form-label fs-8 text-body-highlight ps-0 text-transform-none" for="inputAddress1">Description</label>
                                <textarea id="content" class="form-control" name="content" type="text" placeholder="Description *" required>{{$task->content}}</textarea>
                            </div>
