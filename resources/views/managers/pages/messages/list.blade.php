...
<div class="content">
        ...
        <div class="mb-9">
          <div class="row g-3 mb-4">
            <div class="col-auto">
              <h2 class="mb-0">Fille de discussions</h2>
            </div>
          </div>
                ...
                <table class="table fs-9 mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="sort align-middle text-start ps-4" scope="col" data-sort="price">MESSAGE</th>
                  ...
                  <tbody class="list" id="products-table-body">
                    ...
                    <tr class="position-static">
                        ...
                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="#">{{$message->first_name}}</a></td>
                        <td class="price align-middle white-space-nowrap text-start fw-bold text-body-tertiary ps-4">{{$message -> last_name}}</td>
                        <td class="price align-middle white-space-nowrap text-start fw-bold text-body-tertiary ps-4">{{$message -> classe}}</td>
                        <td class="category align-middle white-space-nowrap text-body-quaternary fs-9 ps-4 fw-semibold">{{ \Carbon\Carbon::parse($message->birthday)->format('M j, Y') }}</td>
                        <td class="tags align-middle review pb-2 ps-3"><a class="text-decoration-none" href="#!"><span class="badge badge-tag me-2 mb-2">{{$message -> city}}</span></a></td>
                        <td class="tags align-middle review pb-2 ps-3">
                            @foreach ($message->his_parents as $his_parent)
                                <span class="badge badge-tag me-2 mb-2">{{ $his_parent->first_name }} {{ $his_parent->last_name }}</span>
                            @endforeach
                        </td>
                        {{-- <td class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">{{$message -> mother_id}}</td> --}}
                        ...
                        @endif --}}
                        {{-- <td class="vendor align-middle text-start fw-semibold ps-4"><a href="#!">{{$message->add_by}}</a></td> --}}
