          ...
          <table class="table fs-9 mb-0 border-top border-translucent">
            ...
            <tbody class="list" id="project-list-table-body">
              ...
              <tr class="position-static">
                ...
                <td class="align-middle time white-space-nowrap ps-0 projectName py-4" style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">{{$assignment->user_name }}</td>
                ...
                <td class="align-middle white-space-nowrap text-start pe-0 ps-4 btn-reveal-trigger">
                    <div class="btn-reveal-trigger position-static">
                      ...
                      <div class="dropdown-menu dropdown-menu-end py-2">
                        <a class="dropdown-item" href="#editAssignBtn" data-bs-toggle="modal" data-product-id="{{$assignment->id}}"
                          data-product-name="{{$assignment->name }}"
                          data-product-content="{{$assignment->user_name }}">Editer l'assignation</a>
                          {{-- <a class="dropdown-item text-danger" href="#" onclick="confirmDelete('{{ route('manager_assign_delete', ['token' => $assignment->token]) }}')">Supprimer</a> --}}
                        </div>
                    </div>
                  </td>
              </tr>
