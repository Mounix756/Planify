<div class="modal fade" id="addMeetBtn" tabindex="-1" aria-labelledby="projectsBoardViewModal" aria-hidden="true">
      ...
      <div class="modal-content overflow-hidden">
        <div class="modal-header position-relative p-0">
          ...
          <div class="row mt-8" style="margin: 20px">
            <form method="post" action="{{route('manager_add_new_meet')}}" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        ...
                        @endif
                        <h3 class="mb-5">Nouvelle réunion</h3>
                        <div class="row g-4">
                            <div class="col-12">
                                <label class="form-label fs-8 text-body-highlight ps-0 text-transform-none" for="inputAddress1">Objet</label>
                                <input class="form-control" id="inputAddress1" name="subject" type="text" placeholder="Objet *" required/>
                            </div>
                            ...
                            <div class="col-12">
                                <label class="form-label fs-8 text-body-highlight ps-0 text-transform-none" for="inputAddress1">Debut</label>
                                <input type="datetime-local" class="form-control" name="start_time" required>
                            </div>

                            <div class="col-12">
                                <label class="form-label fs-8 text-body-highlight ps-0 text-transform-none" for="inputAddress1">Fin</label>
                                <input type="datetime-local" class="form-control" name="end_time" required>
                            </div>

                            <div class="col-12">
                                <label class="form-label fs-8 text-body-highlight ps-0 text-transform-none" for="inputAddress1">Url</label>
                                <input class="form-control" id="inputAddress1" name="url" type="text" placeholder="Url *" />
                            </div>
