...
@extends('collaborators.app.appAuth', ['title' => 'Inscription'])
              ...
              <div class="row align-items-center gx-0 gy-7">
                <div class="col-auto bg-body-highlight dark__bg-gray-1100 rounded-3 position-relative overflow-hidden auth-title-box">
                  ...
                  <div class="position-relative px-4 px-lg-7 pt-7 pb-7 pb-sm-5 text-center text-md-start pb-lg-7 pb-md-7">
                    <h3 class="mb-3 text-body-emphasis fs-7">Bienvenue sur Planify!</h3>
                  ...
                  <div class="position-relative z-n1 mb-6 d-none d-md-block text-center mt-md-15"><img class="auth-title-box-img d-dark-none" src="{{asset('/logo/logo.png')}}" alt="" /><img class="auth-title-box-img d-light-none" src="{{asset('/logo/logo.png')}}" alt="" /></div>
                </div>
                <div class="col mx-auto">
                  <div class="auth-form-box">
                    ...
                    <form action="{{route('collaborator_signin_success')}}" method="post">
                    @csrf
                      @if(session('success'))
