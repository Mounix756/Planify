@extends('collaborators.app.appHome', ['title' => 'Projets'])
...
<div class="content">
    ...
    {{-- <div class="row gx-6 gy-3 mb-4 align-items-center">
      ...
      <div class="col-auto">
        <a class="btn btn-primary px-5" href="#addMeetBtn" data-bs-toggle="modal"><span class="fa-solid fa-plus me-2"></span>Créer une réunion</a></div>
    </div> --}}
    <div class="row justify-content-between align-items-end mb-4 g-3">
      <div class="col-12 col-sm-auto">
        <ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
            <li class="nav-item"><a class="nav-link active" aria-current="page" href="#"><span>Tous </span><span class="text-body-tertiary fw-semibold">({{$meets_count}})</span></a></li>
            ...
            <div class="d-flex justify-content-between align-items-center"><span class="badge badge-phoenix fs-10 badge-phoenix-primary" data-bs-theme="light">Bientôt</span>
              <div class="z-2"><button class="btn btn-icon btn-reveal dropdown-toggle dropdown-caret-none transition-none" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v"></span></button>
                <div class="dropdown-menu dropdown-menu-end py-2">
                    <a class="dropdown-item" href="{{route('meet_show_more', ['token' => $meet->token])}}">Voir plus</a>
                    <a class="dropdown-item" href="!#">Confirmer ma participation</a>
